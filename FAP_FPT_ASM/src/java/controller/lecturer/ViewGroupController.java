...
public class ViewGroupController extends BaseRBACController {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<String> semesters = grDB.getAllSemester();
        ArrayList<Subject> subjects = subDB.getSubjectBySemester(semester);
        ArrayList<Group> groups = grDB.getGroupBySemesterAndSubject(semester, subid);
        
        int gid;
        ArrayList<Student> students = new ArrayList<>();
        if(str_gid != null){
            gid = Integer.parseInt(str_gid);
            students = stuDB.getStudentByGroup(gid);
        }
